...
class SystolicArray2x2:
    ...
    def step(self, a_west, a_valid, b_north, b_valid):
        ...
        pe10_psum_i = self.pe10_psum
        pe10_weight_i = out00["pe_weight_o"]
        pe10_weight_valid_i = 1
        ...
        pe11_psum_i = self.pe11_psum
        pe11_weight_i = out01["pe_weight_o"]  
        pe11_weight_valid_i = 1
        pe11_input_i = out10["pe_input_o"]    
        pe11_input_valid_i = 1
        ...
        self.pe00_psum = out00["pe_psum_o"]
        self.pe01_psum = out01["pe_psum_o"]
        self.pe10_psum = out10["pe_psum_o"]
        self.pe11_psum = out11["pe_psum_o"]
